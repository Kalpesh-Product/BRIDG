  ...
  return (
    <div className="flex flex-col gap-10 md:gap-12 lg:gap-16">
      ...
      <div className='h-full w-full overflow-hidden'>
            <img src={totalSalesBreakdown} alt="image" className='h-full w-full object-cover'/>
            </div>
     ...
     <div>
      ...
      <div className='lg:h-full w-full overflow-hidden'>
            <img src={avgSalesPrice} alt="image" className='h-full w-full object-cover'/>
            </div>
     </div>
     ...
     <div className="flex flex-col gap-4" >
        {/* <ReactFitty className="text-headline">TOTAL RENTAL TRANSACTIONS</ReactFitty> */}
        <ReactFitty >TOTAL RENTAL TRANSACTIONS</ReactFitty>
        {
      ...
      <hr />
        ...
        <ReactFitty className="text-headline">TOP 10 CROSSBOARDER INVESTORS COUNTRIES 
        </ReactFitty>
         <div className="h-full w-full p-4 border border-gray-300 rounded-lg bg-white">
          <img
            src={WorldMap}
