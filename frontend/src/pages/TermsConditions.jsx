...
const TermsConditions = () => {
  return (
    <div className="flex flex-col gap-8">
      <h1 className="text-hero text-center">TERMS AND CONDITIONS</h1>
      <div className="flex flex-col gap-4">
        ...
        <span className="text-body">
          ...
          Conditions (&quot;Terms&quot;) govern your use of our platform,
          located at{" "}
      ...
      <div className="flex flex-col gap-4">
        ...
        <span className="text-body">
          ...
          reached the legal age in your jurisdiction. By using the Service, you
          represent that you are of legal age and have the legal capacity to
      ...
      <div className="flex flex-col gap-4">
        ...
        <span className="text-body">
          ...
          integrations is subject to the terms and conditions of the respective
          third parties.
        </span>
      </div>
      <hr className="border-t-[2px]" />
      <div className="flex flex-col gap-4">
        ...
        <span className="text-body">
          ...
          may be interrupted for maintenance, updates, or technical reasons. We
          are not liable for any loss or damage resulting from interruptions in
          service.
        </span>
      </div>
      <hr className="border-t-[2px]" />
      <div className="flex flex-col gap-4">
        ...
        <span className="text-body">
          ...
          any time. We will provide notice of significant changes by posting the
          updated Terms on our platform or by sending you a notification.
      ...
      <div className="flex flex-col gap-4">
        ...
        <span className="text-body">
          ...
          or expenses arising from your use of the Service, your violation of
          these Terms, or your infringement of any intellectual property or
      ...
      <div className="flex flex-col gap-4">
        ...
        <span className="text-body">
          ...
          but not limited to natural disasters, war, terrorism, cyber-attacks,
      ...
      <div className="flex flex-col gap-4">
        ...
        <span className="text-body">
          ...
          the entire agreement between you and the Company regarding the Service
